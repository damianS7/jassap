...
/**
 * Clase para obtener y guardar informacion sobre el cliente en un fichero
 * @author danjian
 */
public class ClientProperties extends Properties {
	private static final long serialVersionUID = -8126953005213392077L;
	...
	public ClientProperties(File file) throws IOException {
		this.file = file;
	...
	public void save() throws IOException {
		store(new FileOutputStream(file), "Jassap client config");
	}
